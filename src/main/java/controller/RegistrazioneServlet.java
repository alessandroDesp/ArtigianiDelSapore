...
public class RegistrazioneServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(Utilita.contieneParametro(request,"textNome") && Utilita.contieneParametro(request,"textCognome") &&
        Utilita.contieneParametro(request,"textCodiceFiscale") && Utilita.contieneParametro(request,"textDataNascita")&&
        Utilita.contieneParametro(request,"textIndirizzoEmail") && Utilita.contieneParametro(request,"textPassword")) {
