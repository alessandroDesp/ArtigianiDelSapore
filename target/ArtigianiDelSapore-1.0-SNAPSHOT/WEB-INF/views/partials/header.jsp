...
<header class="p-3 mb-3 border-bottom">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav-header col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li>
                ...
                <li>
                    <div class="nav-link px-2 link-dark dropdown no-decoration">
                        <a href="#" class="nav-link d-block link-dark">Cibo</a>
                ...
                <li>
                    <div class="nav-link px-2 link-dark dropdown no-decoration">
                        <a href="#" class="nav-link d-block link-dark">Bevande</a>
                        <ul class="dropdown-content text-small">
                ...
                <li>
                    <div class="nav-link px-2 link-dark dropdown no-decoration">
                        <a href="#" class="nav-link d-block link-dark">Ricette</a>
                ...
                <li>
                    <div class="nav-link px-2 link-dark">
                        <a href="#" class="nav-link d-block link-dark">Provenienza</a>
                    </div>
                </li>
                <li>
                    <div class="nav-link px-2 link-dark">
                        <a href="#" class="nav-link d-block link-dark">Offerte</a>
                    </div>
                </li>
            </ul>

            <form class="col-12 col-lg-auto mb-lg-0 me-lg-3" action="Search" method="post">
                <input type="search" class="form-control" placeholder="Cerca sul sito..." aria-label="Search" name="sValue">
            </form>
